...
#define SOCK_CLIENT_WAIT_TMOUT_S 40    /* Timeout for waiting until all clients connects */
#define TEST_BINARY_ABSOLUTE_PATH "/home/jskowronek/projects/smarthome/build_sim/smarthome_sim" /* Path to binary under test */
/* =============================
 *         UART config
 * =============================*/
